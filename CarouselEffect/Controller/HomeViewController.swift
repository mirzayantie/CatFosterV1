...
class HomeViewController: UIViewController, UICollectionViewDelegate, UICollectionViewDataSource, UIScrollViewDelegate {
   ...
   // var catProfile : [CatProfile] = [CatProfile]()
    ...
    override func viewDidLoad() {
        ...
        guard let image = UIImage(named: "cat logo") else {return}
    ...
    @IBAction func logOutPressed(_ sender: AnyObject) {
        ...
        do {
            ...
            //cause the register and login has back button
            //performSegue(withIdentifier: "login", sender: self)
           
            guard let LoginController = self.storyboard?.instantiateViewController(withIdentifier: "LoginViewController") else {return}
