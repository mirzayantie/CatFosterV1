...
class AddCatController: UIViewController, UITextFieldDelegate, UIImagePickerControllerDelegate, UINavigationControllerDelegate {
    ...
    override func viewDidLoad() {
        ...
        let buttonTint = DynamicColor(hex:  0x95ADBE)
    ...
    private func updateSubmitButtonState(){
        ...
        // if all text field are not empty, enable submit button
